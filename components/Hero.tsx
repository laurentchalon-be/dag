      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-12 duration-1000 ease-out">
          ...
          <div className="flex flex-wrap gap-5 pt-4">
            <button className="px-12 py-5 bg-white text-black rounded-full font-bold text-lg hover:scale-105 transition-all shadow-[0_20px_40px_rgba(255,255,255,0.2)]">
              Begin Journey
            </button>
            <button className="px-12 py-5 glass-liquid rounded-full font-bold text-lg hover:bg-white/10 transition-all">
              Menu Gallery
            </button>
          </div>
        </div>
        ...
        <div className="hidden lg:block relative animate-in fade-in zoom-in duration-1000 delay-300">
          <div className="relative z-10 w-full aspect-[4/5] rounded-[5rem] overflow-hidden glass-liquid p-5 -rotate-2 group hover:rotate-0 transition-transform duration-1000">
            <img 
          ...
          <div className="absolute -top-12 -right-8 glass-liquid px-8 py-5 rounded-[2rem] animate-bounce" style={{ animationDuration: '6s' }}>
